...
def main() -> None:
    ...
    optimizer_backend = cfg.get("optimizer_backend", "openai_chat")
    target_backend = cfg.get("target_backend", "openai_chat")
    set_optimizer_deployment(cfg.get("optimizer_model", default_model_for_backend(optimizer_backend)))
    set_target_deployment(cfg.get("target_model", default_model_for_backend(target_backend)))
    configure_codex_exec(
